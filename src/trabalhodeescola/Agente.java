...
public abstract class Agente {
    ...
    public Agente(String identificacao, int energia_Vital, String classe_Geral, String classe_Especifica){
    ...
    public void setIdentificacao(String identificacao){ //todo agente precisa setar a identificacao
        this.identificacao = identificacao; 
    }
